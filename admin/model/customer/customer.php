...
class ModelCustomerCustomer extends Model {
	...
	public function getCustomerByShippingCode($shipping_code) {
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "customer WHERE shipping_code = '" . $this->db->escape($shipping_code) . "'");
