...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_more_link'])) {
			$data['config_more_link'] = $this->request->post['config_more_link'];
		} else {
			$data['config_more_link'] = $this->config->get('config_more_link');
		}
		...
		if (isset($this->request->post['config_background_color'])) {
			$data['config_background_color'] = $this->request->post['config_background_color'];
		} else {
			$data['config_background_color'] = $this->config->get('config_background_color');
		}
