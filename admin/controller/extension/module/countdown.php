...
class ControllerExtensionModuleCountDown extends Controller {
	...
	public function index() {
		...
		//tnt
		if (isset($this->request->post['tntpcrow'])) {
			$data['tntpcrow'] = $this->request->post['tntpcrow'];
		} elseif (!empty($module_info)) {
			$data['tntpcrow'] = $module_info['tntpcrow'];
		} else {
			$data['tntpcrow'] = '';
		}
		if (isset($this->request->post['tnttbrow'])) {
			$data['tnttbrow'] = $this->request->post['tnttbrow'];
		} elseif (!empty($module_info)) {
			$data['tnttbrow'] = $module_info['tnttbrow'];
		} else {
			$data['tnttbrow'] = '';
		}
		if (isset($this->request->post['tntmbrow'])) {
			$data['tntmbrow'] = $this->request->post['tntmbrow'];
		} elseif (!empty($module_info)) {
			$data['tntmbrow'] = $module_info['tntmbrow'];
		} else {
			$data['tntmbrow'] = '';
		}
			$data['doublerow'] = 1;
