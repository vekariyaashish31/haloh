...
/*TMD*/
				...
				$product_image = $this->model_catalog_product->getProduct($order_product['product_id']);
...
/*TMD*/
				$order_products = $this->model_checkout_order->getOrderProduct($order_info['order_id']);
			
				$this->load->model('catalog/product');
				$product_image = $this->model_catalog_product->getProduct($order_products['product_id']);
				$this->load->model('tool/image');
				if ($product_image['image'] && file_exists(DIR_IMAGE . $product_image['image'])) {
					$image = $this->model_tool_image->resize($product_image['image'], $this->config->get('theme_' . $this->config->get('config_theme') . '_image_cart_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_cart_height'));
				}/*TMD End*/ 
