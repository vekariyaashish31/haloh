	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/product')) {
				...
				$faqgroups = array();
			if ($this->user->hasPermission('access', 'extension/faq')) {		
				$faqgroups[] = array(
					'name'	   => 'Faqs',
					'href'     => $this->url->link('extension/faq', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}
			
			if ($this->user->hasPermission('access', 'extension/faqgroup')) {	
				$faqgroups[] = array(
					'name'	   => 'Faqgroup',
					'href'     => $this->url->link('extension/faqgroup', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);			
			}
			...
			if ($this->user->hasPermission('access', 'catalog/menu')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_top_menu'),
					'href'     => $this->url->link('catalog/menu', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			$sale[] = array(
					'name'	   => 'Pre-Order',
					'href'     => $this->url->link('sale/tntorder', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
