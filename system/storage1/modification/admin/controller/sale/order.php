...
/*TMD End*/ 
		...
		// $order_total = $this->model_sale_order->getTotalOrderstnt($filter_data);
		$order_total = $this->model_sale_order->getTotalOrders($filter_data);

		$results = $this->model_sale_order->getOrders($filter_data);

		foreach ($results as $result) {
			if($result['order_status'] != 'pre order'){
...
'combination_id' => !empty($product['combination_id']) ? $product['combination_id'] : '',
					'name'       => $product['name'],
					'model'      => $product['model'],
		...
		$data['options_combinations_enabled'] = $this->config->get( 'config_opt_comb_status');
		$data['options_reset_button_enabled'] = $this->config->get( 'config_opt_comb_button_reset_options');
		$data['products_table_column_count'] = $data['options_combinations_enabled'] ? 7 : 6;
		$data['totals_table_column_count'] = $data['options_combinations_enabled'] ? 6 : 5;
		$data['sub_totals_table_column_count'] = $data['options_combinations_enabled'] ? 5 : 4; 
 ...
 //echo "<pre>"; print_r($data['histories']); echo "</pre>";die; 
