	...
	public function index() {
		...
		$data['tracking'] = $this->url->link('information/tracking');
			...
			$data['text_faq'] = $this->language->get('text_faq');
				...
				$data['faqbottom'] = $this->config->get('module_faqgroup_bottom');
		...
		$data['categories'] = $this->url->link('information/information', 'information_id=8', true);

		
		$data['more_link'] = explode(',',html_entity_decode($this->config->get('config_more_link'), ENT_QUOTES, 'UTF-8'));
		...
		$data['scripts'] = $this->document->getScripts('footer');
            ...
            // Custom Search
           $data['href_custom_search'] = $this->url->link('extension/module/custom_search', '', true);
            // Custom Search - / End
